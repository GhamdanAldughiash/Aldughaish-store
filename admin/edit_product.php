    ...
    $products = $stmt->get_result(); //[]
       ...
       $category = $_POST['category'];
        ...
        $stmt = $conn->prepare("UPDATE products SET product_name=?, product_description=?, product_price=?,
                                product_special_offer=?, product_brand=?, product_category=?  WHERE product_id=?");
        $stmt->bind_param('ssssssi',$title,$description,$price,$offer,$brand,$category,$product_id);
          ...
          <div class="mx-auto container">
              <form id="edit-form"  method="POST" action="edit_product.php">
                ...
                <div class="form-group mt-2">
                  ...
                  <div class="form-group mt-2">
                      <label>Brand</label>
                      <input type="text" class="form-control" value="<?php  echo $product['product_brand']?>"  id="product-brand" name="brand" placeholder="Brand" required/>
                  </div>
